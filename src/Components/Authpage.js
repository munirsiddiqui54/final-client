...
const AuthPage = (props) => {
    ...
    const onLogin = (e) => {
        e.preventDefault();
        axios
            .post(`${process.env.REACT_APP_API}/login`, { username, secret })
    ...
    return (
        <div className="login page" >
            <div className="m-2" style={{ display: 'flex', width: '100vh' }}>
                {/* Login Form */}
                <div className="m-4">
                    ...
                    <form onSubmit={onLogin}>
                        ...
                        />
                        <button type="submit" className="me-2 btn btn-success">LOG IN</button>
                    </form>
